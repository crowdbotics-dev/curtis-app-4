"""
Django settings for curtis_app_4 project.
...
ROOT_URLCONF = 'curtis_app_4.urls'
...
WSGI_APPLICATION = 'curtis_app_4.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "curtis_app_4 API",
    "DESCRIPTION": "API documentation for curtis_app_4 App",
    "VERSION": "v1",
}
